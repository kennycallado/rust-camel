# Spec Delta: conductor-workflow

Delta spec for the `conductor-delivery-phases` change. Domain: the
`conductor-light` agent workflow (isolation, spec, plan, implementation, close).
Affects no runtime crate.
