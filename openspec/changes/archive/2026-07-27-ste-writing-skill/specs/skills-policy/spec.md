# Spec Delta: skills-policy

Delta spec for the `ste-writing-skill` change. Domain: OpenSpec workflow skills
policy and writing discipline. Affects no runtime crate.
