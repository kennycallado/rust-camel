# error-handler delta — handledby

Implements the e_opus sealed ruling (bd rc-ntpof, 2026-09-24). Scenario
letters (a)-(h) refer to the ruling's enumerated scenarios.
