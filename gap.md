...
- **Impacto:** Alto _boilerplate_ al crear componentes y mayor probabilidad de inconsistencias o errores de parsing de parámetros (ej. timeouts, booleanos).
...
- **Gap:** El swap es "atómico" pero ciego. No espera a que los mensajes que están _dentro_ del pipeline viejo terminen antes de descartarlo.
