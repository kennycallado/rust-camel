...
| SupervisingRouteController                                           | AutoStart postmortem + Future Work     | Media — reintentos automáticos cuando consumer crasha; actualmente `route_controller.rs:436` tiene TODO: status no se actualiza a `Failed` |        |
