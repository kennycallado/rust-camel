...
#[path = "document_error.rs"]
mod document_error;
#[path = "document_interpolate.rs"]
mod document_interpolate;
#[path = "document_parse.rs"]
mod document_parse;

pub use document_error::TestDocError;
pub(crate) use document_parse::{ParsedDocument, parse_document};

use document_interpolate::interpolate_identifier_fields;
use document_parse::classify_yaml_error;
