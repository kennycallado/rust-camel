// camel-quarkus-dsl-native — split-aggregate native-image variant of
// camel-quarkus-dsl (OpenSpec change bench-missing-cells task 2.4).
...
// native run the SAME route code. Dependency set mirrors the JVM
// sibling (jsonpath split expression, core-languages for the Simple
// marker interpolation; NO jackson — the body stays the canonical
// array string).
