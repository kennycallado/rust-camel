...
| [Data format](../data-formats/index.md) | `DataFormat` in `camel-api` | Name; JSON, CSV, XML, ZIP, tar, gzip, tar.gz built-in; Protobuf ships as a separate crate behind a feature |
| WASM plugin | `camel:plugin` WIT in [`camel-wit`](https://github.com/kennycallado/rust-camel/tree/main/crates/camel-wit) | Guest plugin, bean, source, or authorization-policy via `camel-component-wasm` |
