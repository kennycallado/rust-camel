...
Android is not a release target, but the `aarch64-unknown-linux-musl`
...
- for the Termux-maintained trust store instead, run
  ...
  present the fallback stays inactive (see
  [Installation: Android (Termux)](../getting-started/installation.md)).
