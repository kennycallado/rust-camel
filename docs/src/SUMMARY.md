...
- [Components](components/index.md)
  ...
  - [Files, scheduling, and processes](components/local.md)
  ...
  - [Validation, testing, and rendering](components/testing.md)
...
- [CLI reference](cli/index.md)
  - [camel job](cli/job.md)
  - [camel compile](cli/compile.md)
  - [OpenAPI and plugin subcommands](cli/openapi-plugin.md)
